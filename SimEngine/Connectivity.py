            ...
            for listener_id in receivers_by_channel[channel]:
                ...
                if len(transmissions_by_channel[channel]) > 1:
                    for t in transmissions_by_channel[channel]:
                        ...
                        f.write(str(t['tx_mote_id'])+": peamble_pdr-> "+str(peamble_pdr)+" random_value-> "+str(random_value))
                    ...
                    if packet["type"] == "DATA":
                        if sender_mote.id in otherParents:
                            ...
                            if receiver_mote.get_mac_addr() == sender_mote.rpl.getPreferredParent():
                                ...
                                self.check_packet_in_other_parent_waiting_list(secondary_parent,packet,sender_mote,receiver_mote,retriesLeft)
                                ...
                                self.check_packet_in_other_parent_waiting_list(third_parent,packet,sender_mote,receiver_mote,retriesLeft)
            ...
            for t in transmissions_by_channel[channel]:
                ...
                if packet['type'] == 'DATA':
                    if 'mac2' in packet:
                        ...
                        if secondary_parent.id in receiver_list and preferred_parent.id not in receiver_list:
                            ...
                            if third_parent.id in receiver_list and preferred_parent.id not in receiver_list:
                                sender_id = t['tx_mote_id']
                                sender_mote = self.engine.get_mote_by_id(sender_id)
                                retriesLeft = packet['mac']['retriesLeft']
                                appcounter = packet['app']['appcounter']
