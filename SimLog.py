...
# === anycast
DROPREASON_ANYCAST                = u'drop_any_cast'
LOG_PACKET_IN_WAITING_BUCKET2     = {u'type': u'waiting_for_prf_parent_confirmation',            u'keys': [u'_mote_id',u'packet',u'reason']}
LOG_PACKET_IN_WAITING_BUCKET3     = {u'type': u'waiting_for_scnd_parent_confirmation',            u'keys': [u'_mote_id',u'packet',u'reason']}
WAITINGREASON_ANYCAST             = u'waiting_any_cast'
