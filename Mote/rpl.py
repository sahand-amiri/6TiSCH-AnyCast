...
class Rpl(object):
    ...
    def determine_other_parents(self, new_parent, joined_mote):
        # {
            # 1:0,1:1
            # 2:0,2:1
            # 3:0,3:1
        ...
        self.mote.sf.delete_old_other_parents(joined_mote,self.otherParents)
        #then add new secondary and third parents
        if new_parent != None and new_parent != "02-00-00-00-00-01-00-00":
    ...
    def indicate_preferred_parent_change(self, old_preferred, new_preferred):
        ...
        root = motes[0]
        root.rpl.determine_other_parents(new_preferred, self.mote)
